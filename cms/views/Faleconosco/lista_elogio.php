...
<?php
  ...
  $list = $controllerElogio::Listar();
  $cont = 0;

  while($cont < count($list)){
?>
<div class="container_lista_faleconosco">
  <div class="itens_mostrar_faleconosco"><?php echo $list[$cont]->elogio ?></div>
  <div class="itens_mostrar_faleconosco"><?php echo $list[$cont]->email ?></div>
  <div class="itens_mostrar_faleconosco">
    <a href="router.php?controller=faleconosco&modo=elogio&id=<?php echo($list[$cont]->id) ?>">
